...
public class Flightdatadriver1 {
	...
	public static void main(String[] args) throws Exception {
		...
		FileInputFormat.setInputPaths(job , new Path("hdfs://localhost:54310/user/hduser/AirlineVSDelay"));
		FileOutputFormat.setOutputPath(job , new Path("hdfs://localhost:54310/user/hduser/AirlineVSDelay/output"));
